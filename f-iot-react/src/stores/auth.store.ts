  ...
  set => ({
    ...
    tryRefreshToken: async () => {
      try {
        ...
        // : 쿠킹에 저장된 refreshToken을 자동으로 서버에 전송
        const newToken = await refreshAccessToken();

        // 새 토큰을 상테에 저장 - 사용자가 로그인 상태를 유지할수 있음
