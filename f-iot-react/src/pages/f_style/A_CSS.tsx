...
//& "Global CSS"로써 사용 시 
// - CSS 파일을 전역으로 import 하여, 모든 컴포넌트에 스타일 적용 
...
// - reset.css          : 초기화 (UI 프로임워크와 상관없이 필수)
// - variables.css      : CSS 변수 정의 (색상, spacing, typography 등 디자인 변수로 관리)
...
// 4) 페이지 일관성
// 5) 유지보수: 컴포넌트 단위가 많아지면 CSS Moudle, styled-components로 전환
