...
// - 하지만 자바스크립트 내에서 네트워크 요청(HTTP), 파일 읽기, 타이머, 대용량 데이터 연산은 시간 소요가 많음
// >> 해당 동작에서 '동기 프로그래밍' 사용 시 해당 화면이 멈추고 (프리징) 클릭도 못 받는 "끓김" 현상이 발생
...
work(); // work() 작업이 종료되지 않으면 다음 콘솔창 출력X: 동기 프로그래밍
